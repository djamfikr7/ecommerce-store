...
export default function NewProductPage() {
  ...
  // Auto-generate SKU and meta title from name
  useEffect(() => {
    if (formData.name) {
      ...
      setFormData((prev) => ({
        ...prev,
        sku: `SKU-${slug}-${randomSuffix}`,
        metaTitle: `${formData.name} - Premium Quality`,
      }));
    }
  }, [formData.name]);
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl lg:text-3xl font-bold text-white">New Product</h1>
            ...
            <div>
              ...
              {formData.variants.length === 0 && (
                <p className="text-slate-400 mb-4">
                  No variants added yet. Variants allow you to offer different options like
                  size or color for the same product.
                </p>
              )}
        ...
        {activeTab === "seo" && (
          <div className="space-y-6">
            ...
            <div>
              ...
              <input
                type="text"
                value={generateSlug(formData.name) || "product-url-slug"}
                readOnly
                className="w-full px-4 py-2.5 bg-slate-900/30 border border-slate-700 rounded-xl text-slate-400"
              />
              <p className="text-xs text-slate-500 mt-1">
                URL: /products/{generateSlug(formData.name) || "product-url-slug"}
              </p>
            </div>
          </div>
        )}
