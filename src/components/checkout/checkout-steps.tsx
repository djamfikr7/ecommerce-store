...
export function CheckoutSteps({ currentStep, completedSteps, onStepClick }: CheckoutStepsProps) {
              ...
              <div className="flex flex-1 flex-col items-center">
                <motion.button
                  ...
                  className={`relative flex h-12 w-12 items-center justify-center rounded-full transition-all duration-300 ${
                    isCompleted ? 'shadow-accent-primary/30 bg-accent-primary shadow-lg' : ''
                  } ${isActive ? 'shadow-accent-primary/50 bg-accent-primary shadow-lg' : ''} ${
                    !isActive && !isCompleted ? 'neo-raised-sm bg-surface-elevated' : ''
